...
public class SolidityListenerImpl implements SolidityListener {

    @Override
    public void enterSourceUnit(SolidityParser.SourceUnitContext ctx) {
        // Ta metoda zostanie wywołana, gdy parser zacznie analizować plik Solidity
    }

    @Override
    public void exitSourceUnit(SolidityParser.SourceUnitContext ctx) {
        // Ta metoda zostanie wywołana, gdy parser skończy analizować plik Solidity
    }
    ...
    @Override
    public void enterNatSpec(SolidityParser.NatSpecContext ctx) {
    ...
    public void enterContractDefinition(SolidityParser.ContractDefinitionContext ctx) {
        // Ta metoda zostanie wywołana, gdy parser napotka definicję kontraktu
    }

    @Override
    public void exitContractDefinition(SolidityParser.ContractDefinitionContext ctx) {
        // Ta metoda zostanie wywołana, gdy parser skończy analizować definicję kontraktu
    }
    ...
    public void visitTerminal(TerminalNode node) {
        // Ta metoda zostanie wywołana, gdy parser napotka terminal (np. literał, operator, nawias)
    }
